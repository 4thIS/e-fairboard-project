...
constexpr TemplateDef TEMPLATES[TEMPLATE_COUNT] = {
    // 행사 안내
    {0, "행사 안내", 4, {
        {0, "제목", 48, 100, 72, 2, 48, 1208, 0},
        {1, "일시", 240, 408, 56, 0, 33, 664, 0},
        {2, "장소", 240, 560, 56, 0, 33, 664, 0},
        {3, "주최", 240, 712, 56, 0, 33, 664, 0},
    ...
    // 일정표
    {1, "일정표", 6, {
        {0, "시간1", 84, 352, 56, 1, 12, 270, 0},
        {1, "세션1", 408, 352, 56, 0, 45, 840, 0},
        {2, "시간2", 84, 482, 56, 1, 12, 270, 0},
        {3, "세션2", 408, 482, 56, 0, 45, 840, 0},
        {4, "시간3", 84, 612, 56, 1, 12, 270, 0},
        {5, "세션3", 408, 612, 56, 0, 45, 840, 0},
    }, {1060, 760, 180},
    7, {
        {0, 0, 1304, 200, 2, 0, 0},
    ...
    // 프로젝트 소개
    {2, "프로젝트 소개", 3, {
        {0, "프로젝트명", 48, 104, 72, 2, 48, 1160, 0},
        {1, "태그라인", 48, 196, 40, 2, 87, 1160, 0},
        {2, "설명", 48, 320, 40, 0, 255, 920, 560},
        {0, nullptr, 0, 0, 0, 0, 0, 0, 0},
        {0, nullptr, 0, 0, 0, 0, 0, 0, 0},
        {0, nullptr, 0, 0, 0, 0, 0, 0, 0},
    }, {1032, 600, 208},
    ...
    // 프로젝트 소개(세로)
    {3, "프로젝트 소개(세로)", 3, {
        {0, "프로젝트명", 48, 112, 72, 2, 36, 888, 0},
        {1, "태그라인", 48, 204, 40, 2, 66, 888, 0},
        {2, "설명", 48, 320, 40, 0, 255, 888, 660},
        {0, nullptr, 0, 0, 0, 0, 0, 0, 0},
        {0, nullptr, 0, 0, 0, 0, 0, 0, 0},
        {0, nullptr, 0, 0, 0, 0, 0, 0, 0},
    }, {712, 1020, 208},
