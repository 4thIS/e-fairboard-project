...
constexpr TemplateDef TEMPLATES[TEMPLATE_COUNT] = {
    // 행사 안내
    {0, "행사 안내", 4, {
        {0, "제목", 48, 100, 72, 2, 51, 0},
        {1, "일시", 240, 292, 56, 0, 57, 0},
        {2, "장소", 240, 416, 56, 0, 57, 0},
        {3, "주최", 240, 540, 56, 0, 57, 0},
    ...
    // 프로젝트 소개
    {2, "프로젝트 소개", 3, {
        {0, "프로젝트명", 48, 72, 72, 0, 30, 740},
        {1, "태그라인", 48, 180, 56, 1, 39, 740},
        {2, "설명", 48, 412, 56, 0, 39, 740},
        {0, nullptr, 0, 0, 0, 0, 0, 0},
        {0, nullptr, 0, 0, 0, 0, 0, 0},
        {0, nullptr, 0, 0, 0, 0, 0, 0},
    }, {912, 348, 284},
