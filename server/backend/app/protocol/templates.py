...
#
# font_size 는 16 의 정수배만 쓴다 (이슈 #12). 노드 폰트가 16×16 비트맵(efb_hangul16)이라
# 정수 배율만 가능 — 12/14/20/24px 은 렌더러가 올려 그려서 글자가 잔린다.
#
# 12.48" e-Paper 1304×984 기준 (팀 소개는 패널을 세워 984×1304). 7.5"(800×480)에서 이관.
# 대형 전시 디스플레이라 멀리서도 읽히게 폰트 확대: 제목/헤더 80px, 본문 48px, 부스 강조 128px.
