...
#
# font_size 는 32 의 정수배만 쓴다. 노드 폰트가 32×32 비트맵(나눔고딕 파생 efb_hangul32,
# GLYPH_CELL=32)이라 정수 배율만 가능 — scale = font_px / 32. (고해상도 전환, 이슈 #12 후속.)
#
# 12.48" e-Paper 1304×984 기준 (팀 소개는 패널을 세워 984×1304). 7.5"(800×480)에서 이관.
# 폰트: 제목/헤더 96px(3배), 본문 64px(2배), 부스 강조 128px(4배). 대형 디스플레이용.
