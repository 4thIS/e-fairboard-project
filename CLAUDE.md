...
| 담당 | 브랜치 | 영역 |
|------|:---:|------|
| 우진 (팀장) | `wj` | **웹 전체** — 프론트엔드 + 백엔드(`server/`, FastAPI 서버·대시보드·시리얼 브리지·가상 시뮬레이터) |
| 준표 | `jp` | **모듈 펌웨어 코딩 + 프로토콜 스펙 주관** — LoRa 게이트웨이(`gateway/`) + e-Paper 노드(`node/`)(RadioLib·GxEPD2·QR·딥슬립), PROTOCOL.md 관리 |
...
- 수정일시: 2026-07-08 19:33 (KST) — 역할 분담 재정리(웹=우진 / 모듈펌웨어=준표 / 하드웨어=효민)
